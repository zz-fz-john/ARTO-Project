...
make test-combo
cd build
${ROOT_DIR}/llvm-16.0/llvm-project-16.0.0/build/bin/llvm-dis test_combo.bc -o test_combo.ll || exit 1
${ROOT_DIR}/llvm-16.0/llvm-project-16.0.0/build/bin/clang test_combo.ll -O3 -target arm-linux-gnueabihf  -lm -lresolv  -lpthread -o "$1"_test_combo ||exit 1
