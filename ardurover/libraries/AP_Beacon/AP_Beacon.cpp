...
unsigned long long AP_Beacon_update_total = 0;
unsigned long long AP_Beacon_update_count = 0;
std::chrono::high_resolution_clock::time_point AP_Beacon_update_t1;
std::chrono::high_resolution_clock::time_point AP_Beacon_update_t2;
...
{
    AP_Beacon_update_t1 = std::chrono::high_resolution_clock::now();
    ...
    AP_Beacon_update_t2 = std::chrono::high_resolution_clock::now();
    auto duration = std::chrono::duration_cast<std::chrono::microseconds>(AP_Beacon_update_t2 -AP_Beacon_update_t1).count();
    AP_Beacon_update_total += duration;
    AP_Beacon_update_count += 1;
    if (AP_Beacon_update_count % 100 == 0){
        printf("average AP_Beacon update measure time microseconds is %f!\n",AP_Beacon_update_total/100.0);
        AP_Beacon_update_total = 0;
        AP_Beacon_update_count = 0;
    }    
}
