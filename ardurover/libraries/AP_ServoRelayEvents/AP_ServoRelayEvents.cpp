...
unsigned long long AP_ServoRelayEvents_update_events_total = 0;
unsigned long long AP_ServoRelayEvents_update_events_count = 0;
std::chrono::high_resolution_clock::time_point AP_ServoRelayEvents_update_events_t1;
std::chrono::high_resolution_clock::time_point AP_ServoRelayEvents_update_events_t2;
...
{
    AP_ServoRelayEvents_update_events_t1= std::chrono::high_resolution_clock::now();
    ...
    AP_ServoRelayEvents_update_events_t2 = std::chrono::high_resolution_clock::now();
    auto duration = std::chrono::duration_cast<std::chrono::microseconds>(AP_ServoRelayEvents_update_events_t2 - AP_ServoRelayEvents_update_events_t1).count();
    AP_ServoRelayEvents_update_events_total += duration;
    AP_ServoRelayEvents_update_events_count += 1;
    if (AP_ServoRelayEvents_update_events_count % 100 == 0){
        printf("average update_home_from_EKF measure time microseconds is %f!\n",AP_ServoRelayEvents_update_events_total/100.0);
        AP_ServoRelayEvents_update_events_total = 0;
        AP_ServoRelayEvents_update_events_count = 0; 
    }
}
