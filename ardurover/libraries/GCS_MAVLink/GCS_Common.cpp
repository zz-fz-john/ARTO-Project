...
unsigned long long GCS14update_receive_total = 0;
unsigned long long GCS14update_receive_count = 0;
std::chrono::high_resolution_clock::time_point GCS14update_receive_t1;
std::chrono::high_resolution_clock::time_point GCS14update_receive_t2;


unsigned long long GCS14update_send_total = 0;
unsigned long long GCS14update_send_count = 0;
std::chrono::high_resolution_clock::time_point GCS14update_send_t1;
std::chrono::high_resolution_clock::time_point GCS14update_send_t2;
}
...
{
    GCS14update_send_t1=std::chrono::high_resolution_clock::now();
    ...
    GCS14update_send_t2 = std::chrono::high_resolution_clock::now();
    auto duration = std::chrono::duration_cast<std::chrono::microseconds>(GCS14update_send_t2 -GCS14update_send_t1).count();
    GCS14update_send_total += duration;
    GCS14update_send_count += 1;
    if (GCS14update_send_count % 100 == 0){
        printf("average GCS14update_send measure time microseconds is %f!\n",GCS14update_send_total/100.0);
        GCS14update_send_total = 0;
        GCS14update_send_count = 0; 
    }
}
...
{
    GCS14update_receive_t1 = std::chrono::high_resolution_clock::now();
    for (uint8_t i=0; i<num_gcs(); i++) {
        chan(i)->update_receive();
    }
    // also update UART pass-thru, if enabled
    update_passthru();
    GCS14update_receive_t2 = std::chrono::high_resolution_clock::now();
    auto duration = std::chrono::duration_cast<std::chrono::microseconds>(GCS14update_receive_t2 - GCS14update_receive_t1).count();
    GCS14update_receive_total += duration;
    GCS14update_receive_count += 1;
    if (GCS14update_receive_count % 100 == 0){
        printf("average GCS14update_receive measure time microseconds is %f!\n",GCS14update_receive_total/100.0);
        GCS14update_receive_total = 0;
        GCS14update_receive_count = 0;
    }
}
