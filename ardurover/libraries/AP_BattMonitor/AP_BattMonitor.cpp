...
unsigned long long AP_BattMonitor_read_total = 0;
unsigned long long AP_BattMonitor_read_count = 0;
std::chrono::high_resolution_clock::time_point AP_BattMonitor_read_t1;
std::chrono::high_resolution_clock::time_point AP_BattMonitor_read_t2;
...
{
    AP_BattMonitor_read_t1= std::chrono::high_resolution_clock::now();
    ...
    checkPoweringOff();
    AP_BattMonitor_read_t2 = std::chrono::high_resolution_clock::now();
    auto duration = std::chrono::duration_cast<std::chrono::microseconds>(AP_BattMonitor_read_t2 -AP_BattMonitor_read_t1).count();
    AP_BattMonitor_read_total += duration;
    AP_BattMonitor_read_count += 1;
    if (AP_BattMonitor_read_count % 100 == 0){
        printf("average AP_BattMonitor_read measure time microseconds is %f!\n",AP_BattMonitor_read_total/100.0);
        AP_BattMonitor_read_total = 0;
        AP_BattMonitor_read_count = 0; 
    }
}
