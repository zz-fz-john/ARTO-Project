...
void __attribute__((annotate("critical function")))AC_AttitudeControl::input_euler_angle_roll_pitch_euler_rate_yaw(float euler_roll_angle_cd, float euler_pitch_angle_cd, float euler_yaw_rate_cds)
{
    // Convert from centidegrees on public interface to radians
    float __attribute__((annotate("nova_sensitive_var")))  euler_roll_angle = radians(euler_roll_angle_cd * 0.01f);
    float __attribute__((annotate("nova_sensitive_var")))  euler_pitch_angle = radians(euler_pitch_angle_cd * 0.01f);
    float __attribute__((annotate("nova_sensitive_var")))  euler_yaw_rate = radians(euler_yaw_rate_cds * 0.01f);
