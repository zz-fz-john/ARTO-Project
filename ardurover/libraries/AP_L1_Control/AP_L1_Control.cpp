...
void __attribute__((annotate("critical function")))AP_L1_Control::update_waypoint(const struct Location &prev_WP, const struct Location &next_WP, float dist_min)
{

    struct Location _current_loc;
    float __attribute__((annotate("nova_sensitive_var")))Nu;
    float __attribute__((annotate("nova_sensitive_var")))xtrackVel;
    float __attribute__((annotate("nova_sensitive_var")))ltrackVel;
