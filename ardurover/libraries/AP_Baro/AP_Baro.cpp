...
std::chrono::high_resolution_clock::time_point AP_Baro_update_t1;
std::chrono::high_resolution_clock::time_point AP_Baro_update_t2;
...
{
    AP_Baro_update_t1= std::chrono::high_resolution_clock::now();
...
#define MASK_LOG_ANY                    0xFFFF
    ...
    AP_Baro_update_t2 = std::chrono::high_resolution_clock::now();
    auto duration = std::chrono::duration_cast<std::chrono::microseconds>(AP_Baro_update_t2 -AP_Baro_update_t1).count();
    AP_Baro_update_total += duration;
    AP_Baro_update_count += 1;
    if (AP_Baro_update_count % 100 == 0){
        printf("average AP_Baro_update measure time microseconds is %f!\n",AP_Baro_update_total/100.0);
