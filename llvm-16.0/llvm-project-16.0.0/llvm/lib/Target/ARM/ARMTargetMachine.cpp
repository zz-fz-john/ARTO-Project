...
extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeARMTarget() {
  ...
  initializeARMCollectIndirectJumpPass(Registry);// add
  initializeARMSFIPass(Registry);// add
}
...
void ARMPassConfig::addPreEmitPass() {
  //add  pass
  addPass(createARMCollectIndirectJumpPass());// add
  addPass(createARMSFIPass());// add
