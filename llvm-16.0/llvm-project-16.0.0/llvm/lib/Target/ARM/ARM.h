...
FunctionPass *createARMCollectIndirectJumpPass();// add
FunctionPass *createARMSFIPass();// add
...
void initializeARMCollectIndirectJumpPass(PassRegistry &);// add
void initializeARMSFIPass(PassRegistry &);// add
} // end namespace llvm
