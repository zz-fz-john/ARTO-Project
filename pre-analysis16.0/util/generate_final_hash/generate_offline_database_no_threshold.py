...
def main():
    ...
    if args.to_insert_func_file is None:
        exit("%s: --to_insert_func_file (-tiff) is required" % sys.argv[0])
    if args.svf_result_file is None:
        exit("%s: --svf_result_file (-svf) is required" % sys.argv[0])
    if args.IR_file is None:
        exit("%s: --IR_file (-IR) is required" % sys.argv[0])
