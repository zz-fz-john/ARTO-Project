...
unsigned long long update_land_and_crash_detectors_update_total = 0;
unsigned long long update_land_and_crash_detectors_update_count = 0;
uint64_t update_land_and_crash_detectors_update_t1;
uint64_t update_land_and_crash_detectors_update_t2;
TimingLogger update_land_and_crash_detectors_update_logger("update_land_and_crash_detectors_update");
...
{
    update_land_and_crash_detectors_update_t1= AP_WCET::now_us();
    ...
    thrust_loss_check();
    yaw_imbalance_check();
    update_land_and_crash_detectors_update_t2 = AP_WCET::now_us();
    uint64_t duration = update_land_and_crash_detectors_update_t2 - update_land_and_crash_detectors_update_t1;
    update_land_and_crash_detectors_update_total += duration;
    update_land_and_crash_detectors_update_count += 1;
    if (update_land_and_crash_detectors_update_count % 1000 == 0){
       // printf("average update_land_and_crash_detectors measure time microseconds is %f!\n",update_land_and_crash_detectors_update_total/1000.0);
        update_land_and_crash_detectors_update_total = 0;
        update_land_and_crash_detectors_update_count = 0;
    }
    update_land_and_crash_detectors_update_logger.log(duration);
}
