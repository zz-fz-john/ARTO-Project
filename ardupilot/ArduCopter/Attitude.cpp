...
uint64_t update_throttle_hover_t1;
uint64_t update_throttle_hover_t2;
TimingLogger update_throttle_hover_logger("update_throttle_hover");
...
{
    update_throttle_hover_t1 = AP_WCET::now_us();
    ...
    update_throttle_hover_t2 = AP_WCET::now_us();
    uint64_t duration = update_throttle_hover_t2 -update_throttle_hover_t1;
    update_throttle_hover_total += duration;
    update_throttle_hover_count += 1;
    if (update_throttle_hover_count % 100 == 0){
        //printf("average update_throttle_hover measure time microseconds is %f!\n",update_throttle_hover_total/100.0);
        update_throttle_hover_total = 0;
        update_throttle_hover_count = 0;
        update_throttle_hover_count=0;
    }
    update_throttle_hover_logger.log(duration);
}
