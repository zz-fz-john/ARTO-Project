...
uint64_t arm_motors_check_t1;
uint64_t arm_motors_check_t2;
TimingLogger arm_motors_check_logger("arm_motors_check");

unsigned long long auto_disarm_check_total = 0;
unsigned long long auto_disarm_check_count = 0;
uint64_t auto_disarm_check_t1;
uint64_t auto_disarm_check_t2;
TimingLogger auto_disarm_check_logger("auto_disarm_check");

unsigned long long lost_vehicle_check_total = 0;
unsigned long long lost_vehicle_check_count = 0;
uint64_t lost_vehicle_check_t1;
uint64_t lost_vehicle_check_t2;
TimingLogger lost_vehicle_check_logger("lost_vehicle_check");

unsigned long long motors_output_total = 0;
unsigned long long motors_output_count = 0;
uint64_t motors_output_t1;
uint64_t motors_output_t2;
TimingLogger motors_output_logger("motors_output");
...
{
    arm_motors_check_t1 = AP_WCET::now_us();
    ...
    arm_motors_check_t2 = AP_WCET::now_us();
    uint64_t duration = arm_motors_check_t2 -arm_motors_check_t1;
    arm_motors_check_total += duration;
    arm_motors_check_count += 1;
    if (arm_motors_check_count % 100 == 0){
        printf("average arm_motors_check measure time microseconds is %f!\n",arm_motors_check_total/100.0);
        arm_motors_check_total = 0;
        arm_motors_check_count = 0;
        arm_motors_check_count = 0;
    }
    arm_motors_check_logger.log(duration);
}

// auto_disarm_check - disarms the copter if it has been sitting on the ground in manual mode with throttle low for at least 15 seconds
void Copter::auto_disarm_check()
{
    auto_disarm_check_t1 = AP_WCET::now_us();
    ...
    auto_disarm_check_t2 = AP_WCET::now_us();
    uint64_t duration = auto_disarm_check_t2 -auto_disarm_check_t1;
    auto_disarm_check_total += duration;
    auto_disarm_check_count += 1;
    if (auto_disarm_check_count % 100 == 0){
       // printf("average auto_disarm_check measure time microseconds is %f!\n",auto_disarm_check_total/100.0);
        auto_disarm_check_total = 0;
        auto_disarm_check_count = 0;
        auto_disarm_check_count=0;

    }
    auto_disarm_check_logger.log(duration);
}

// motors_output - send output to motors library which will adjust and send to ESCs and servos
void Copter::motors_output()
{
    motors_output_t1 = AP_WCET::now_us();
    ...
    if (g2.afs.should_crash_vehicle()) {
        ...
        if (!g2.afs.terminating_vehicle_via_landing()) {
            motors_output_t2 = AP_WCET::now_us();
            uint64_t duration = motors_output_t2 - motors_output_t1;
            motors_output_total += duration;
            motors_output_count += 1;
            if (motors_output_count % 1000 == 0){
              //  printf("average motors_output measure time microseconds is %f!\n", motors_output_total/1000.0);
                motors_output_total = 0;
                motors_output_count = 0;
            }
            motors_output_logger.log(duration);
            return;
        }
...
{
    lost_vehicle_check_t1 = AP_WCET::now_us();
    ...
    lost_vehicle_check_t2 = AP_WCET::now_us();
    uint64_t duration = lost_vehicle_check_t2 -lost_vehicle_check_t1;
    lost_vehicle_check_total += duration;
    lost_vehicle_check_count += 1;
    if (lost_vehicle_check_count % 1000 == 0){
        //printf("average lost_vehicle_check measure time microseconds is %f!\n",lost_vehicle_check_total/1000.0);
        lost_vehicle_check_total = 0;
        lost_vehicle_check_count = 0;
    }
    lost_vehicle_check_logger.log(duration);
}
