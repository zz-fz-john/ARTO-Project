...
unsigned long long AP_OpticalFlow6update_update_total = 0;
unsigned long long AP_OpticalFlow6update_update_count = 0;
uint64_t AP_OpticalFlow6update_update_t1;
uint64_t AP_OpticalFlow6update_update_t2;
TimingLogger AP_OpticalFlow6update_update_logger("AP_OpticalFlow6update_update");
...
{
    AP_OpticalFlow6update_update_t1 = AP_WCET::now_us();
    ...
    AP_OpticalFlow6update_update_t2 = AP_WCET::now_us();
    uint64_t duration = AP_OpticalFlow6update_update_t2 -AP_OpticalFlow6update_update_t1;
    AP_OpticalFlow6update_update_total += duration;
    AP_OpticalFlow6update_update_count += 1;
    if (AP_OpticalFlow6update_update_count % 1000 == 0){
       // printf("average AP_OpticalFlow6update measure time microseconds is %f!\n",AP_OpticalFlow6update_update_total/1000.0);
        AP_OpticalFlow6update_update_total = 0;
        AP_OpticalFlow6update_update_count = 0;
    }
    AP_OpticalFlow6update_update_logger.log(duration);
}
