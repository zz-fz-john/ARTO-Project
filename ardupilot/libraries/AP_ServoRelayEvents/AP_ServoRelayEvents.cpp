...
uint64_t AP_ServoRelayEvents_update_events_t1;
uint64_t AP_ServoRelayEvents_update_events_t2;
TimingLogger AP_ServoRelayEvents_update_events_logger("AP_ServoRelayEvents_update_events");
...
{
    AP_ServoRelayEvents_update_events_t1= AP_WCET::now_us();
    ...
    AP_ServoRelayEvents_update_events_t2 = AP_WCET::now_us();
    uint64_t duration = AP_ServoRelayEvents_update_events_t2 - AP_ServoRelayEvents_update_events_t1;
    AP_ServoRelayEvents_update_events_total += duration;
    AP_ServoRelayEvents_update_events_count += 1;
    if (AP_ServoRelayEvents_update_events_count % 1000 == 0){
        //printf("average update_home_from_EKF measure time microseconds is %f!\n",AP_ServoRelayEvents_update_events_total/1000.0);
        AP_ServoRelayEvents_update_events_total = 0;
        AP_ServoRelayEvents_update_events_count = 0;
    }
    AP_ServoRelayEvents_update_events_logger.log(duration);
}
