...
namespace {
unsigned long long AP_InertialSensor6update_total = 0;
unsigned long long AP_InertialSensor6update_count = 0;
uint64_t AP_InertialSensor6update_t1;
uint64_t AP_InertialSensor6update_t2;
TimingLogger AP_InertialSensor6update_logger("AP_InertialSensor6update");

unsigned long long AP_InertialSensor_periodic_total = 0;
unsigned long long AP_InertialSensor_periodic_count = 0;
uint64_t AP_InertialSensor_periodic_t1;
uint64_t AP_InertialSensor_periodic_t2;
TimingLogger AP_InertialSensor_periodic_logger("AP_InertialSensor_periodic");
}
...
{
    AP_InertialSensor_periodic_t1 = AP_WCET::now_us();
    batchsampler.periodic();
    AP_InertialSensor_periodic_t2 = AP_WCET::now_us();
    uint64_t duration = AP_InertialSensor_periodic_t2 - AP_InertialSensor_periodic_t1;
    AP_InertialSensor_periodic_total += duration;
    AP_InertialSensor_periodic_count += 1;
    if (AP_InertialSensor_periodic_count % 1000 == 0){
       // printf("average AP_InertialSensor_periodic measure time microseconds is %f!\n", AP_InertialSensor_periodic_total/1000.0);
        AP_InertialSensor_periodic_total = 0;
        AP_InertialSensor_periodic_count = 0;
    }
    AP_InertialSensor_periodic_logger.log(duration);
}
...
{
    AP_InertialSensor6update_t1= AP_WCET::now_us();
...
#endif
    AP_InertialSensor6update_t2 = AP_WCET::now_us();
    uint64_t duration = AP_InertialSensor6update_t2 -AP_InertialSensor6update_t1;
    AP_InertialSensor6update_total += duration;
    AP_InertialSensor6update_count += 1;
    if (AP_InertialSensor6update_count % 1000 == 0){
       // printf("average AP_InertialSensor6update measure time microseconds is %f!\n",AP_InertialSensor6update_total/1000.0);
        AP_InertialSensor6update_total = 0;
        AP_InertialSensor6update_count = 0;
    }
    AP_InertialSensor6update_logger.log(duration);
}
